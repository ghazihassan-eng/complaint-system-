...
{
    public partial class adminpanel5 : UserControl
    {
        public adminpanel5()
        {
            InitializeComponent();
        ...
        public void load()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from INCOMETAX", con.connect());
            DataTable dt = new DataTable();
            adp.Fill(dt);
            dataGridView1.DataSource = dt;
        }

        private void adminpanel5_Load(object sender, EventArgs e)
        {
        ...
        public void display()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from SOLVED_INCOMTAX", con.connect());
            SqlCommand cm = new SqlCommand("insert into SOLVED_INCOMTAX(NAME,CNIC,AREA,SUB_AREA,COMPLAINT)values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')", con.connect());
            cm.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               // co = new SqlConnection("Data Source=DESKTOP-K4OP1A5;Initial Catalog=complaint_system;Integrated Security=True");
                ...
                display();
                con.connect();
                SqlCommand cmd = new SqlCommand("delete from INCOMETAX where ID=" + textBox6.Text + "", con.connect());
                cmd.ExecuteNonQuery();
                load();
                textBox6.Clear();
            }
