...
{
    public partial class adminpanel4 : UserControl
    {
        public adminpanel4()
        {
            InitializeComponent();
        ...
        public void load()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from WATER", con.connect());
            DataTable dt = new DataTable();
            adp.Fill(dt);
            dataGridView1.DataSource = dt;
        }
        private void adminpanel4_Load(object sender, EventArgs e)
        {
        ...
        public void display()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from SOLVED_WATER", con.connect());
            SqlCommand cm = new SqlCommand("insert into SOLVED_WATER(NAME,CNIC,AREA,SUB_AREA,COMPLAINT)values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')", con.connect());
            cm.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                display();
                SqlCommand cmd = new SqlCommand("delete from WATER where ID=" + textBox6.Text + "", con.connect());
                cmd.ExecuteNonQuery();
                load();
                textBox6.Clear();
            }
