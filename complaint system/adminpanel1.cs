...
{
    public partial class adminpanel1 : UserControl
    {
        public adminpanel1()
        {
            InitializeComponent();
        ...
        public void load()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from POLICE",con.connect());
        ...
        public void display()
        {
            SqlDataAdapter adp = new SqlDataAdapter("select * from SOLVED_police", con.connect());
            SqlCommand cm = new SqlCommand("insert into SOLVED_police(NAME,CNIC,AREA,SUB_AREA,COMPLAINT)values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "')", con.connect());
            cm.ExecuteNonQuery();
            ...
            SqlCommand cmd = new SqlCommand("delete from POLICE where ID=" + textBox6.Text + "",con.connect());
            cmd.ExecuteNonQuery();
            load();
            textBox1.Clear();
            textBox2.Clear();
